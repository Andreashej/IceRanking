...
import { faInfo, faSync, faWifi, faListOl, faUser, faHorseHead, faCalendarAlt, faQuestion, faTimes, faSearch, faCalendarPlus, faTachometerAlt, faCheckCircle, faCheck, faClock, faDesktop, faBullhorn, faAddressCard, faListUl, faPlus, faCog, faLink } from '@fortawesome/free-solid-svg-icons'
import { Dashboard } from "./pages/Dashboard/Dashboard";
import { CompetitionCreate } from "./pages/CompetitionCreate/CompetitionCreate";
import { UserProvider } from "./contexts/user.context";
import { ToastProvider } from "./contexts/toast.context";
    
library.add(fab, faListOl, faUser, faHorseHead, faCalendarAlt, faQuestion, faTimes, faSearch, faCalendarPlus, faTachometerAlt, faCheck, faCheckCircle, faClock, faDesktop, faWifi, faBullhorn, faAddressCard, faListUl, faInfo, faSync, faPlus, faCog, faLink);
