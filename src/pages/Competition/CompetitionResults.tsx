...
const CompetitionResultItem: React.FC<FlatListItem<Result, Test>> = ({
  item: result,
  extraData: test,
}) => {
...
export const CompetitionResults: React.FC = () => {
  ...
  const [uploadResultsDialog, setUploadResultsDialog] =
  ...
  return (
    <>
        ...
        {competition?.isAdmin && (
          ...
          >
            <Button
              ...
              tooltip="Upload results"
              tooltipOptions={tooltipOptions}
              onClick={() => setUploadResultsDialog(true)}
            />
            <Button
      ...
      />
      <Dialog
        header="Upload results (XLS)"
        visible={uploadResultsDialog}
        onHide={() => setUploadResultsDialog(false)}
      >
